...
def load_rm_decoder(lib):
        #This function is added by the author to output the RM decoder result for one block
...
def sample_binary_vector(n2, min_weight, max_weight):
    ...
    Args:
    n2 (int): Length of the binary vector.
    min_weight (float): Minimum Hamming weight as a fraction of n2.
    max_weight (float): Maximum Hamming weight as a fraction of n2.

    Returns:
    np.array: Binary vector with specified properties.
    """
